      ...
      <Container size="xl" className="mt-[-60px]">
        <Box className="padding-container" pb={24}>
          ...
          <Group  gap="xl">
            ...
            >
              Welcome to TripWagon Holidays™
            </Title>
            <Text size="md" c="gray">
            TripWagon Holidays™ is the largest most reputable service provider of <Link href={"/packages"}> Kerala taxi packages/services </Link>,<Link href={"/rentals"}> Kerala car rentals</Link>,<Link href={"/traveller"}> Kerala Tempo Traveller</Link>.
...
TripWagon Holidays™ laid new foundations in the field of <Link href={"/taxi"}> Kerala taxi services </Link>(Kochi Taxi) by providing unparalleled service to our clients in exploring Kerala - "God's own country" with our owned fleet of vehicles ranging from small cabs to big luxury coaches with total strength of more than 150 in numbers. Our drivers are specially trained in tourism with good knowledge about Kerala geography and good communication skills to offer safe travel across Kerala along with our dedicated staff working 24 hours to create most cherishing memorable memories for our clients without any failure.
            </Text>
          </Group>
        </Box>
